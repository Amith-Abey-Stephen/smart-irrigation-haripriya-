<template>
  <usernav></usernav>
    ...
    <div class="ml-[17rem] ">
        <div class="flex justify-center gap-2 pr-2 mt-[3rem]">
            <a href="#"
                class=" block w-full p-9 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            ...
            <a href="#"
                ...
                <form class=" mx-auto grid grid-cols-2 gap-4">
                    <div>
        ...
        <div>
            <button type="button" class=" mt-6 ml-[20rem]  w-96 text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Schedule</button>
        </div>
    </div>
    <br>
    <div class="ml-[17rem] pr-2">
